...
GtkWidget *
huayra_hig_workarea_table_add_section_title(GtkWidget *table, guint *row, const char *section_title)
{
	...
	gtk_widget_set_valign (section_label, GTK_ALIGN_CENTER);
...
void
huayra_hig_workarea_table_add_wide_tall_control(GtkWidget *table, guint *row, GtkWidget *widget)
{
	gtk_grid_attach (GTK_GRID(table), widget, 0, *row, 2, 1);
	gtk_widget_set_margin_start (GTK_WIDGET(widget), 12);
